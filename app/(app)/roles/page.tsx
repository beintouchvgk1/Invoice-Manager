...
export default function RolesPage() {
  ...
  const filteredModules = useMemo(() => {
    ...
    // showing them as assignable checkboxes on any other role would be misleading,
                  ...
                  <div className="perm-header">
                    ...
                    <div className="perm-header-right">
                      <span className="perm-count">
                        {isSuperAdminRole ? permissionCount(selectedRole) : draftPermissions.length} / {permissionTotal(selectedRole)} permissions
                      </span>
                      <div className="ac">
